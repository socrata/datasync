...
public class MetadataJobTab implements JobTab {
    ...
    public MetadataJobTab(MetadataJob job, JFrame containingFrame) {
        ...
        JButton loadMetadataButton = new JButton("Get Dataset Metadata");
...
//            int numExtensions = MetadataJob.allowedFileToPublishExtensions.size();
//            String[] allowedFileExtensions = new String[numExtensions];
//            for(int i = 0; i < numExtensions; i++) {
//                if(i > 0)
//                    extensionsMsg += ", ";
//                allowedFileExtensions[i] = MetadataJob.allowedFileToPublishExtensions.get(i);
