...
Launch DataSync navigating to the folder containing the Datasync1.5.jar that you downloaded previously and run the following command:

```
java -jar datasync1.5.jar
```
